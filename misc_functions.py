...
def load_model(model_name):
    ...
    best_model_path = '/Users/Shintaro/Documents/Kaggle-comps/PlantTraits/best_models/no_feat-3.pth'
...
class cube_CNN(nn.Module):
    ...
    def __init__(self, num_classes, aux_num_classes, feature_cols):
        ...
        self.conv_feat1 = nn.Linear(163, 256)
    ...
    def forward(self, img, feature):
        ...
        conv_feat_x = self.fc_dropout(self.batchnn1d1(self.conv_feat1(lin_conv)))
