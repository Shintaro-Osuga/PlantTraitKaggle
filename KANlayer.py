# This is from the KAN paper with source code found at: https://github.com/KindXiaoming/pykan/tree/master
# This is not my original implementation and is copied from the KAN paper to simplify changes and use
...
class KANLayer(nn.Module):
    ...
    def forward(self, x):
        ...
        # print(x.shape)
        # print(torch.ones(self.out_dim, device=self.device).shape)
        # print(torch.einsum('ij,k->ikj', x, torch.ones(self.out_dim, device=self.device)).shape)
